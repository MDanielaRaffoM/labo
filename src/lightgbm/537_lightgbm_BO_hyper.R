...
kBO_iter  <- 250   #aumento las iteraciones ya que tengo dos hiperparametros mas
...
hs <- makeParamSet( 
         ...
         makeIntegerParam("max depth",        lower= 1L     , upper=   50L),
         makeIntegerParam("min_gain_to_split",lower=  0L    , upper=   1L),
         makeIntegerParam("max_bin",          lower=  1L    , upper=   100L),
        )

ksemilla_azar  <- 102667  #Aqui poner la propia semilla
