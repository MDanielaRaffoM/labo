...
AgregarVariables  <- function( dataset )
{
  ...
  dataset[  , rentab_sobrehist  := mmrentabilidad_annual / mean(mrentabilidad_annual) ]
  dataset[ , inv_saldo := (minversion1_pesos + minversion1_dolares + minversion2) / mcuentas_saldo ]
  dataset[ , pseudoliq :=  mcuentas_saldo / (mprestamos_personales + mprestamos_prendarios + mprestamos_hipotecarios) ]
